...
- You can convert [RF-DETR](https://github.com/roboflow/rf-detr), [YOLOv5](https://github.com/ultralytics/yolov5), [YOLOv8/YOLO11/YOLO26](https://github.com/ultralytics/ultralytics), and [MobileNetV2 + SSDLite](https://machinethink.net/blog/mobilenet-ssdlite-coreml/) models to Core ML models.
