...
# View menus
- [Trackpad gestures](https://rectlabel.com/export#trackpad-gestures)
- [Magic Mouse gestures](https://rectlabel.com/export#magic-mouse-gestures)
- [Zoom in, Zoom out](https://rectlabel.com/export#zoom-in-zoom-out)
- [Zoom fit](https://rectlabel.com/export#zoom-fit)
- [Focus box](https://rectlabel.com/export#focus-box)
- [Hide buttons](https://rectlabel.com/export#hide-buttons)
- [Hide cross hairs](https://rectlabel.com/export#hide-cross-hairs)
- [Hide other boxes](https://rectlabel.com/export#hide-other-boxes)
- [Hide keypoints names](https://rectlabel.com/export#hide-keypoints-names)
- [Hide pixels](https://rectlabel.com/export#hide-pixels)
- [Hide superpixels](https://rectlabel.com/export#hide-superpixels)
- [Show small pixels](https://rectlabel.com/export#show-small-pixels)
- [Show other pixels](https://rectlabel.com/export#show-other-pixels)
- [Show boxes on keypoints](https://rectlabel.com/export#show-boxes-on-keypoints)
- [Show labels on boxes](https://rectlabel.com/export#show-labels-on-boxes)
- [Show coordinates on boxes](https://rectlabel.com/export#show-coordinates-on-boxes)
- [Show indexes on points](https://rectlabel.com/export#show-indexes-on-points)
- [Show indexes on labels table](https://rectlabel.com/export#show-indexes-on-labels-table)
- [Show checkboxes on labels table](https://rectlabel.com/export#show-checkboxes-on-labels-table)
- [Show depth image](https://rectlabel.com/export#show-depth-image)
- [Reload the image](https://rectlabel.com/export#reload-the-image)
- [Enter gallery view](https://rectlabel.com/export#enter-gallery-view)
- [Enter full screen](https://rectlabel.com/export#enter-full-screen)
